...
int main (int argc, char **argv)
{
  ...
  // we can delete the declaration here because these variables are global
  // float* d_Cos;
  // float* d_Sin;

  // we allocate the variables in a different manner
  ...
  // Now we turn this into global memory
